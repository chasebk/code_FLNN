...
from model.main.hybrid_flnn import PsoFlnn
from utils.IOUtil import read_dataset_file
from utils.SettingPaper import flpsonn_paras as param_grid
...
if test_type == "normal":           ### For normal test
    ...
    all_model_file_name = "stability_flpsonn"
else:
    pass
...
def train_model(item):
    ...
    pso_paras = {
        "epoch": item["epoch"], "pop_size": item["pop_size"], "w_minmax": item["w_minmax"], "c_minmax": item["c_minmax"]
    }
    md = PsoFlnn(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, pso_paras=pso_paras)
    md._running__()
