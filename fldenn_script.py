...
from model.main.hybrid_flnn import DeFlnn
from utils.IOUtil import read_dataset_file
from utils.SettingPaper import fldenn_paras as param_grid
...
if test_type == "normal":           ### For normal test
    ...
    all_model_file_name = "stability_fldenn"
else:
    pass
...
def train_model(item):
    ...
    md = DeFlnn(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, de_paras=de_paras)
    md._running__()
