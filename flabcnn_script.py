...
from model.main.hybrid_flnn import AbcFlnn
from utils.IOUtil import read_dataset_file
from utils.SettingPaper import flabcnn_paras as param_grid
...
if test_type == "normal":           ### For normal test
    ...
    all_model_file_name = "stability_flabcnn"
else:
    pass
...
def train_model(item):
    ...
    abc_paras = {
        "epoch": item["epoch"], "pop_size": item["pop_size"], "couple_bees": item["couple_bees"],
        "patch_variables": item["patch_variables"], "sites": item["sites"]
    }
    md = AbcFlnn(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, abc_paras=abc_paras)
    md._running__()
